...
var author$project$Main$GotLoginUrl = function (a) {
	return {$: 'GotLoginUrl', a: a};
};
...
var author$project$Main$discoverUrlsDecoder = A2(elm$json$Json$Decode$field, 'login', elm$json$Json$Decode$string);
...
var author$project$Main$discoverUrls = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$GotLoginUrl, author$project$Main$discoverUrlsDecoder),
		url: 'https://prod-s0-webapp-proxy.nubank.com.br/api/discovery'
	});
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{cpf: '', loginUrl: '', password: '', preferredName: '', token: ''},
		author$project$Main$discoverUrls);
};
...
var author$project$Main$GotCustomerDetails = function (a) {
	return {$: 'GotCustomerDetails', a: a};
};
var author$project$Main$customerDecoder = A2(elm$json$Json$Decode$field, 'preferred_name', elm$json$Json$Decode$string);
var elm$http$Http$Header = F2(
	function (a, b) {
		return {$: 'Header', a: a, b: b};
	});
var elm$http$Http$header = elm$http$Http$Header;
var author$project$Main$customerInformation = F2(
	function (url, token) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotCustomerDetails, author$project$Main$customerDecoder),
				headers: _List_fromArray(
					[
						A2(elm$http$Http$header, 'X-Correlation-Id', 'WEB-APP.pewW9'),
						A2(elm$http$Http$header, 'User-Agent', 'GUI Metrics Test'),
...
var author$project$Main$GotAuthenticationDetails = function (a) {
	return {$: 'GotAuthenticationDetails', a: a};
};
...
var author$project$Main$authenticationDecoder = A3(
	elm$json$Json$Decode$map2,
	F2(
		function (token, customerUrl) {
			return {customerUrl: customerUrl, token: token};
		}),
...
var author$project$Main$requestEncoder = F2(
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'login',
					elm$json$Json$Encode$string(cpf)),
					_Utils_Tuple2(
					'password',
					elm$json$Json$Encode$string(password)),
					_Utils_Tuple2(
					'client_id',
					elm$json$Json$Encode$string('other.conta')),
					_Utils_Tuple2(
					'client_secret',
					elm$json$Json$Encode$string('yQPeLzoHuJzlMMSAjC-LgNUJdUecx8XO'))
				]));
	});
...
var author$project$Main$userLogin = F3(
	function (url, cpf, password) {
		var body = elm$http$Http$jsonBody(
			A2(author$project$Main$requestEncoder, cpf, password));
		return elm$http$Http$post(
			{
				body: body,
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotAuthenticationDetails, author$project$Main$authenticationDecoder),
				url: url
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DispatchLogin':
				return _Utils_Tuple2(
					model,
					A3(author$project$Main$userLogin, model.loginUrl, model.cpf, model.password));
			case 'GotLoginUrl':
				if (msg.a.$ === 'Ok') {
					var url = msg.a.a;
					return _Utils_Tuple2(
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{token: data.token}),
						A2(author$project$Main$customerInformation, data.customerUrl, data.token));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				if (msg.a.$ === 'Ok') {
					var preferredName = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
...
var author$project$Main$CpfInputChanged = function (a) {
	return {$: 'CpfInputChanged', a: a};
};
var author$project$Main$DispatchLogin = {$: 'DispatchLogin'};
var author$project$Main$PasswordInputChanged = function (a) {
	return {$: 'PasswordInputChanged', a: a};
};
...
var author$project$Main$loginForm = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Events$onSubmit(author$project$Main$DispatchLogin)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$value(model.cpf),
						elm$html$Html$Events$onInput(author$project$Main$CpfInputChanged)
					]),
				_List_Nil),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onInput(author$project$Main$PasswordInputChanged)
					]),
				_List_Nil),
				A2(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.loginUrl)
					])),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.token)
					])),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				...
				_List_fromArray(
					[
						elm$html$Html$text('You PreferredName is: ' + model.preferredName)
					]))
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"CpfInputChanged":["String.String"],"PasswordInputChanged":["String.String"],"DispatchLogin":[],"GotLoginUrl":["Result.Result Http.Error String.String"],"GotAuthenticationDetails":["Result.Result Http.Error { token : String.String, customerUrl : String.String }"],"GotCustomerDetails":["Result.Result Http.Error String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));